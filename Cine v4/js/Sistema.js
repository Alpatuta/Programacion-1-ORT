class Sistema {
    ...
    modificarPelicula(pIdPelicula, pNombre, pAnio, pGenero, pImagen) {
        let peli = this.obtenerPeliculaPorId(pIdPelicula);
        peli.nombre = pNombre;
        peli.anio = pAnio;
        peli.idGenero = pGenero;
        peli.imagen = pImagen;
    }

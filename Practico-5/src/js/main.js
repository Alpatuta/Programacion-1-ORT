...
document.querySelector("#btnMostrarArray").addEventListener("click", mostrarListado);
...
//Ejercicio 3
document.querySelector("#btnAgregarNumeros").addEventListener("click", numPromedio);
...
function promedio() {
    ...
    document.querySelector("#pPromedios").innerHTML = `Promedio: ${valorFinal.toFixed(2)}`;
}
